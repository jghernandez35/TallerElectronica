...
import com.zeus.tallerelectronica.sessionbean.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private com.zeus.tallerelectronica.sessionbean.RolFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundleadmin").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundleadmin").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundleadmin").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
