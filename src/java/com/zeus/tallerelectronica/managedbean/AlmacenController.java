...
import com.zeus.tallerelectronica.sessionbean.AlmacenFacade;
...
public class AlmacenController implements Serializable {
    ...
    @EJB
    private com.zeus.tallerelectronica.sessionbean.AlmacenFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundleadmin").getString("AlmacenCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundleadmin").getString("AlmacenUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundleadmin").getString("AlmacenDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class AlmacenControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Almacen) {
                ...
                return getStringKey(o.getAlmId());
            } else {
