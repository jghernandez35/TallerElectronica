...
import com.zeus.tallerelectronica.entidades.Tipodocumento;
...
import com.zeus.tallerelectronica.sessionbean.TipodocumentoFacade;
...
public class TipodocumentoController implements Serializable {
    ...
    @EJB
    private com.zeus.tallerelectronica.sessionbean.TipodocumentoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundleadmin").getString("TipodocumentoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundleadmin").getString("TipodocumentoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundleadmin").getString("TipodocumentoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class TipodocumentoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipodocumento) {
                ...
                return getStringKey(o.getTipdocId());
            } else {
