...
import com.zeus.tallerelectronica.sessionbean.MarcaFacade;
...
public class MarcaController implements Serializable {
    ...
    @EJB
    private com.zeus.tallerelectronica.sessionbean.MarcaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundleadmin").getString("MarcaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundleadmin").getString("MarcaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundleadmin").getString("MarcaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
