...
import com.zeus.tallerelectronica.entidades.Departamento;
...
import com.zeus.tallerelectronica.sessionbean.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private com.zeus.tallerelectronica.sessionbean.DepartamentoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundleadmin").getString("DepartamentoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundleadmin").getString("DepartamentoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundleadmin").getString("DepartamentoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
