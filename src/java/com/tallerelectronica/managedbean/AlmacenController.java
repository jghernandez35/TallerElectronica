...
import com.tallerelectronica.sessionbean.AlmacenFacade;
...
public class AlmacenController implements Serializable {
    ...
    @EJB
    private com.tallerelectronica.sessionbean.AlmacenFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleGeneral").getString("AlmacenCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleGeneral").getString("AlmacenUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleGeneral").getString("AlmacenDeleted"));
        if (!JsfUtil.isValidationFailed()) {
