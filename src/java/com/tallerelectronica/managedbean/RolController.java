...
import com.tallerelectronica.sessionbean.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private com.tallerelectronica.sessionbean.RolFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleGeneral").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleGeneral").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleGeneral").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
