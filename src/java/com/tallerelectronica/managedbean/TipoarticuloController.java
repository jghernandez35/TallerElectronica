...
import com.tallerelectronica.sessionbean.TipoarticuloFacade;
...
public class TipoarticuloController implements Serializable {
    ...
    @EJB
    private com.tallerelectronica.sessionbean.TipoarticuloFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleGeneral").getString("TipoarticuloCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleGeneral").getString("TipoarticuloUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleGeneral").getString("TipoarticuloDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class TipoarticuloControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipoarticulo) {
                ...
                return getStringKey(o.getTipIdTipoArticulo());
            } else {
