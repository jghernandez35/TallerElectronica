...
import com.tallerelectronica.sessionbean.GarantiaFacade;
...
public class GarantiaController implements Serializable {
    ...
    @EJB
    private com.tallerelectronica.sessionbean.GarantiaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleGeneral").getString("GarantiaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleGeneral").getString("GarantiaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleGeneral").getString("GarantiaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Garantia getGarantia(java.lang.Integer id) {
    ...
    public static class GarantiaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Garantia) {
                ...
                return getStringKey(o.getGarId());
            } else {
