...
import com.tallerelectronica.sessionbean.MarcaFacade;
...
public class MarcaController implements Serializable {
    ...
    @EJB
    private com.tallerelectronica.sessionbean.MarcaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleGeneral").getString("MarcaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundleGeneral").getString("MarcaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleGeneral").getString("MarcaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class MarcaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Marca) {
                ...
                return getStringKey(o.getMarIdMarca());
            } else {
